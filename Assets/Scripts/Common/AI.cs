...
//     /// <returns></returns>
//     private static Vector2Int? GetPriorityPosition(Unit user, List<Vector2Int> positions, Func<Vector2Int, int> priorityFunc)
//     {
...
//         return GetPriorityPosition(user, TargetPositions, _ => { return 0; });
//     }
...
//             return GetPriorityPosition(user, MovePositions, _ => { return 0; });
//         }
//         else
//             return null;
//     }
