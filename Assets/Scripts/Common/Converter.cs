...
public class Converter
{
    ...
    public static SortedSet<Vector2Int> ParseRangeData(string data)
    {
        SortedSet<Vector2Int> list = new SortedSet<Vector2Int>();
        var rows = data.Split(';');
...
//         /// Clone 해서 사용
//         /// </summary>
//         public static List<StateEffect> AllEffects = new List<StateEffect>()
//         {
