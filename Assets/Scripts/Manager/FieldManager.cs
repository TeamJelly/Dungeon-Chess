...
namespace Model.Managers
{
    ...
    public class TilemapData
    {
        ...
        public List<List<string>> fieldStrData;

        public TilemapData() { }
        public TilemapData(int width, int height, List<List<string>> str)
        {
            this.width = width;
            this.height = height;
        ...
        public void ToJson(TilemapData data)
        {
    ...
    public class FieldManager : Singleton<FieldManager>
    {
        ...
        public TilemapData fieldData;

        public SortedSet<Vector2Int> allTilesPosition
        {
            get
            {
        ...
        public void InitField(TilemapData fieldData)
        {
            //Chunk 테스트.
            /*chunk = new Chunk();
            chunk.GenerateMap();
