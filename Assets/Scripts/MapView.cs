...
//                         //각 방의 버튼마다 이벤트 부여
//                         AllRoomButtons[i, j].properties.onClick.AddListener(() => StageManager.instance.VisitRoom(room));
...
//             if (StageManager.instance.roomHistory.Contains(A.position) && StageManager.instance.roomHistory.Contains(B.position))
//                 line.GetComponent<Image>().color = Color.black;
//             else if (StageManager.instance.currentRoom == A)
