...
{
    [SerializeField] private float strToDam;
    [SerializeField] private int fixedDam;
    ...
    //     {
    //         ReuseTime = 1;
    //         AvilablePosition = Common.Data.MakeRangeData(1, 2);
    //         RangePosition = Common.Data.MakeRangeData(1, 1);
    //         strToDam = 1.0f;
    //         fixedDam = 10;
    //     }
    //     else if (Level == 1)
    ...
    //         ReuseTime = 1;
    //         AvilablePosition = Common.Data.MakeRangeData(1, 2);
    //         RangePosition = Common.Data.MakeRangeData(2, 1);
    //         strToDam = 1.5f;
    //         fixedDam = 10;
    //     }
    //     else if (Level == 2)
    ...
    //     {
    //         ReuseTime = 0;
    //         AvilablePosition = Common.Data.MakeRangeData(1, 4);
    //         RangePosition = Common.Data.MakeRangeData(2, 1);
    //         strToDam = 2.0f;
    //         fixedDam = 20;
    //     }
