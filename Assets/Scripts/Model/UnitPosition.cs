...
namespace Model
{
    ...
    public class UnitPosition
    {
        ...
        public UnitPosition()
        {
            lowerLeft = new Vector2Int();
            upperRight = new Vector2Int();
        }
        ...
        {
            transform.position = new Vector3((float)(lowerLeft.x + upperRight.x) / 2, (float)(lowerLeft.y + upperRight.y) / 2, transform.position.z);
