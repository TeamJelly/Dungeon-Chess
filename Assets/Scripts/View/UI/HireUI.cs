...
namespace View.UI
{
    public class HireUI : MonoBehaviour
    {
        ...
        [Header("[중앙 패널]")]
        public PixelButton nextButton;
        public PixelButton prevButton;
        ...
        private void Start()
        {
            ...
            startButton.onClick.AddListener(Hire);
            ...
            nextButton.properties.onClick.AddListener(ShowNextUnit);
            prevButton.properties.onClick.AddListener(ShowPrevUnit);
        ...
        void UpdateUI()
        {
            ...
            nameText.text = $"{currentUnit.Modifier} {currentUnit.Name}";
        ...
        {
            nextButton.SetInteractable(idx < unitImagies.Count - 1);
            prevButton.SetInteractable(idx > 0);
            index = idx;
            UpdateUI();
        }
        ...
        public void ShowNextUnit()
        {
            ...
            if(index == unitImagies.Count - 1) nextButton.SetInteractable(false);
            UpdateUI();
        }
        ...
        public void ShowPrevUnit()
        {
            ...
            if(index == 0) prevButton.SetInteractable(false);
            UpdateUI();
        }
